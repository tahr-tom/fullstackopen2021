...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    props.addNew({
      content: content.DomProps.value,
      author: author.DomProps.value,
      info: author.DomProps.value,
      votes: 0
    })
    props.showAndHideWith(`a new anecdote ${content.DomProps.value} created!`)
    navigate('/')
  }
